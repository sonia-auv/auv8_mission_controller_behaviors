...
class AlignRoulette(EventState):
    def __init__(self, topic_to_listen, bounding_box = 100, target_width = 0.15, target_height = 1.2, max_queue_size = 10, control_bounding_box = 0.5, nb_pixel_to_victory = 375):
        super(AlignRoulette, self).__init__(outcomes=['continue', 'failed', 'forward'])
        ...
        self.param_bounding_box = bounding_box
        self.param_vision_target_width_in_meter = target_width
        self.param_vision_target_height_in_meter = target_height
        self.param_topic_to_listen = topic_to_listen
        self.param_max_queue_size = max_queue_size
        self.param_control_bounding_box_in_y = control_bounding_box
        self.param_nb_pixel_to_victory = nb_pixel_to_victory
