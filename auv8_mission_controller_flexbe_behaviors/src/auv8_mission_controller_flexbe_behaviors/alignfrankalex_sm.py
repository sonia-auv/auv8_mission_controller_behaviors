	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('the best align',
										AlignAlexFrank(object_height=450, object_width=300, distance_to_target=1, yaw_adjustment=10, max_time=100, topic_to_listen='/proc_image_processing/execution_953_result', image_height=1544, image_width=2064, speed=0.1, maximum_alignment=10, queue_size=10),
